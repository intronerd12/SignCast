...
DATA_FILE = os.path.join(_DIR, "data", "landmark_dataset.json")
MODEL_SAVE_PATH = os.path.join(_DIR, "models", "landmark_model.pth")
LABELS_SAVE_PATH = os.path.join(_DIR, "models", "landmark_labels.json")
BATCH_SIZE = 32
NUM_EPOCHS = 100
LEARNING_RATE = 0.005
