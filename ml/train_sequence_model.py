...
DATA_FILE = os.path.join(_DIR, "data", "sequence_dataset.json")
MODEL_SAVE_PATH = os.path.join(_DIR, "models", "sequence_model.pth")
LABELS_SAVE_PATH = os.path.join(_DIR, "models", "sequence_labels.json")
BATCH_SIZE = 16
NUM_EPOCHS = 100
LEARNING_RATE = 0.001
